...
class Pessoas
{
	...
	{
		return "SELECT p.* FROM pessoas p";
	}


	// ENDEREÇOS -----------------------------------------------
	public function obtemRegistrosEnderecos($id = "")
	{
		global $gId;
		...
		$sql = "SELECT
					...
					complemento,
					bairro,
					p.id_enderecos_estados,
					p.id_enderecos_cidades,
					p.id_enderecos_paises,
					p.numero,
					p.cep
	...
	*/
	public function geraCamposDoFormularioEnderecos(&$frm, $registroAtual, $proximaPagina = "", $gIdEnd)
	{
	...
	public function geraCamposDoFormularioCfop(&$frm)
	{
		global $o, $sp, $gId;
	...
	*/
	public function preparaCamposEndereco($todosOsCampos)
	{
		$campos = [];
	...
	*/
	public function insereEndereco($todosOsCampos, $gId)
	{
	...
	*/
	public function modificaEndereco($todosOsCampos, $gId, $gIdEnd)
	{
		$todosOsCampos['id_pessoas'] = $gId;
	...
	* Formata campos de endereços enviados pelas funções de persistência no banco de dados
	*/
	public function preparaCamposOcorrencia($todosOsCampos)
	{
		$campos = [];
		$campos['id_pessoas']=intval($todosOsCampos['id_pessoas']);
	...
	* Cria um novo registro no banco de dados e salva valores passados (tratando dados antes)
	*/
	public function insereOcorrencia($todosOsCampos, $gId)
	{
		$todosOsCampos['id_pessoas'] = $gId;
	...
	* Modifica um registro no banco de dados e salva com valores passados (tratando dados antes)
	*/
	public function modificaOcorrencia($todosOsCampos, $gId, $gIdEnd)
	{
		$todosOsCampos['id_pessoas']=$gId;
	...
	public function atualizarPessoasSituacao($idPessoa) {
		...
		if (!$verificarPessoasFilial) {
			...
			dbFastQuery("UPDATE pessoas SET situacao = 'Ativo' WHERE id = " . $idPessoa);
		}
	}


	// ANEXOS -----------------------------------------------
	public function obtemRegistrosAnexos($id="")
	{
	...
	public function geraCamposDoFormularioAnexos(&$frm, $irParaPagina)
	{
		global $gId, $html, $o;
	...
	public function anexoRemover($id)
	{
		$id = intval($id);
