<?php
require_once 'lib/CnabPHP/Remessa.php';
require_once 'lib/CnabPHP/Retorno.php';
...
class gCnab 
{
	 ...
	 * 
	 */
	public function novaRemessa($codigo_banco)
	{
	 ...
	 */
	public function remessaCabecalho($cabecalho)
	{
	 ...
	 * @param array $boleto
	 */
	public function remessaDetalhe($boleto)
	{
	 ...
	 */
	public function remessaSalvarEmArquivo($caminho='')
	{
		$this->remessa->salvarArquivo($caminho);
	}

	public function remessaDownloadFile($nome)
	{
	 ...
	 */
	public function novoRetorno($caminho)
	{
