...
use Cnab\Retorno\Cnab400\Rateio;
    ...
    public function __construct($codigo_banco, $filename, $layoutVersao = null)
    {
        ...
        foreach ($linhas as $linha) {
            ...
            if ($tipo_registro == '0' && $linha) {
                ...
                $nosso_numero_atual = $detalhe->getNossoNumero();
                ...
                $rateio->loadFromString($linha);
                $this->rateios[$nosso_numero_atual.$detalhe->getCodigo()][] = $rateio;
