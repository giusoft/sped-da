...
class gDashboard
{
        ...
        if ($jarr['id'])
        {
            if ($gBASE=="gadmin")
            {
                ...
                if (file_exists($imgLocal)) {
                    $imgWeb = '<img class="dash-img" src="files/pessoas/imagem/' . $jarr['id'] . '.jpeg?' . rand(1, 9999) . '">';
                } else {
                    $imgLocal = $gPath."files/pessoas/imagem/".$jarr['id'].".jpg";
                    if (file_exists($imgLocal)) {
                        $imgWeb = '<img class="dash-img" src="files/pessoas/imagem/' . $jarr['id'] . '.jpg?' . rand(1, 9999) . '">';
                    } else {
            ...
            } elseif ($SITE=="gWMS")
            {
                ...
                if (file_exists($imgLocal)) {
                    $imgWeb = '<img class="dash-img" src="files/pessoas/' . $jarr['id'] . '.jpeg?' . rand(1, 9999) . '">';
                } else {
                    $imgLocal = $gPath."files/pessoas/".$jarr['id'].".jpg";
                    if (file_exists($imgLocal)) {
                        $imgWeb = '<img class="dash-img" src="files/pessoas/' . $jarr['id'] . '.jpg?' . rand(1, 9999) . '">';
                    } else {
                ...
                if (file_exists($imgLocal)) {
                    $imgWeb = '<img class="dash-img" src="files/geral_pessoas/' . $jarr['id'] . '.jpg?' . rand(1, 9999) . '">';
                } else {
    ...
    function render()
    {
        ...
        .dash-img {
            ...
            border-radius: 60%;
            display: inline;
            // filter: drop-shadow(5px 3px 6px #aaaaaa);
            -webkit-box-shadow: 5px 3px 8px 6px rgba(200,200,200,0.4);
            box-shadow: 5px 3px 8px 6px rgba(200,200,200,0.4);
