...
/** Exibe texto na tela HTML (n�o sai nada se $this->filter<>"")
 * @author	giuliano
 * @param mixed $var Texto
 * @return mixed $sai O pr�prio texto
 */
	function gOut($txt)
	{
		if ($this->_getFilter()=="")
...
/** Gera c�digo inicial HTML (<html>...<body>)
 * @author	giuliano
 * @param mixed $filter Tipo de exporta��o (PDF, DOC, XLS, ...)
 * @return mixed $sai C�digo HTML
 */
	...
	/** Gera c�digo final HTML (</body></html>)
	 * @author	giuliano
	 * @return mixed $sai C�digo HTML
	 */
	function gEnd()
	{
		...
		{
			// mostra bot�o pra carregar o menu
		}
	 ...
	 * @param mixed $alert Se <true>, aparece real�ado
	 * @return mixed $sai C�digo HTML
	 */
	...
	/** Exibe mensagem do tipo t�tulo na tela HTML e seta t�tulo do PDF
	 * @author	giuliano
	 * @param mixed $text Texto
	 * @return mixed $sai C�digo HTML
	 */
	...
	{
		$this->gOut("<a href='#' style='text-decoration: none' onClick='javascript: window.location.reload();' title='Clique aqui para atualizar esta p&aacute;gina'>");
		$this->gMsg($text,2);
		$this->gOut("</a>");
		$this->report_title=$text;
	}

	/** Exibe mensagem do tipo sub-t�tulo na tela HTML e seta sub-t�tulo do PDF
	 * @author	giuliano
	 * @param mixed $text Texto
	 * @return mixed $sai C�digo HTML
	 */
  ...
  function gTableBegin($style=gT_DEFAULT,$border=false, $controls=false)
	...
	/** Gera c�digo HTML de fechamento de tabela ou monta arquivo exportado
	 * @author	giuliano
	 * @return mixed $sai C�digo HTML
	 */
	function gTableEnd()
	...
	/** Gera c�digo HTML de in�cio de linha (<tr>)
	 * @author	giuliano
	 * @param mixed $param Algum par�metro adicional
	 * @return mixed $sai C�digo HTML
	 */
	...
	/** Gera c�digo HTML de final de linha (</tr>)
	 * @author	giuliano
	 * @return mixed $sai C�digo HTML
	 */
	...
	/** Gera c�digo HTML de in�cio de coluna (<td>)
	 * @author	giuliano
	 * @param mixed $param Algum par�metro adicional
	 * @return mixed $sai C�digo HTML
	 */
	...
	/** Gera c�digo HTML de final de coluna (</td>)
	 * @author	giuliano
	 * @return mixed $sai C�digo HTML
	 */
	 ...
	 * @param mixed $style Tipo de linha gerada (cabe�alho, detalhe, rodap�,etc.)
	 * @param mixed $param Algum par�metro adicional
	 * @return mixed $sai C�digo HTML
	 */
	...
	/** Gera c�digo HTML completo pra exibi��o de uma tabela
	 * @author	giuliano
	 * @param mixed $mtz Array com linhas e colunas a serem criadas
	 * @param mixed $style Tamanho da tabela
	 * @param boolean $border Define se a tabela � com ou sem borda
	...
	/** Gera c�digo HTML completo pra exibi��o de uma tabela com base em query
	 * @author	giuliano
	 * @param mixed $mtz Array com linhas e colunas a serem criadas
	 * @param mixed $style Tamanho da tabela
	 * @param boolean $border Define se a tabela � com ou sem borda
	...
	/** Gera um tag para exibir um �cone
	 * @author Giuliano Nascimento
	 * @param string $file nome do arquivo de imagem (localizado no img_2.0)
	 * @param string $param qualquer paremetro HTML extra
	 * @param string $link link para ser executado ao clicar na imagem
	...
	/** Cria link HTML com base nos par�metros
	 * @author Giuliano Nascimento
	 * @param mixed $text Texto
	 * @param mixed $link Link
	 * @param mixed $target P�gina alvo no frame
	...
	/** Mostra c�digo fonte da p�gina atual - DESATIVADO
	 * @author Giuliano Nascimento
	 * @return string codigo HTML
	 */
