...
$cryptwidth  = 190;  // Largeur du cryptogramme (en pixels)
...
$charspace = 28;        // Espace entre les caracteres (en pixels)
$charsizemin = 17;      // Taille minimum des caractères
$charsizemax = 20;      // Taille maximum des caractères
...
$noisepxmin = 20;      // Bruit: Nb minimum de pixels aléatoires
$noisepxmax = 50;      // Bruit: Nb maximum de pixels aléatoires

$noiselinemin = 1;     // Bruit: Nb minimum de lignes aléatoires
$noiselinemax = 3;     // Bruit: Nb maximum de lignes aléatoires
...
$cryptformat = "jpg";   // Format du fichier image généré "GIF", "PNG" ou "JPG"
