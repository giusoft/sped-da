...
<meta name="Generator" content="Projeto BoletoPHP - www.boletophp.com.br - Licenca GPL" />
...
<script>
	function imprimir()
	{
	document.getElementById('instr_content').innerHTML="";
	window.print();
	}
</script>
...
<div id="container">
	...
	<div id="instr_header">
		<img src="<?echo $http_lib;?>boletos/imagens/logo_empresa.png" border="0">
			<?php echo "<b>".$dadosboleto["identificacao"]."</b><br>".$dadosboleto["servico"]." - Recibo do Sacado"; ?>
			<!--
...
<!--
 ...
 -->
		...
		<div id="instr_content">
			...
			<br><input type="button" value="Clique aqui para imprimir este boleto" onclick="imprimir()"><br>&nbsp;
		</div>	<!-- id="instr_content" -->
	</div>	<!-- id="instructions" -->
...
do Sacado</b></div></TD></tr></tbody></table>
		...
		<tbody>
		<tr>
			<td width=150><IMG SRC="<?echo $http_lib;?>boletos/imagens/logobb.jpg"></td>
			<td width=50>
