        ...
        for ($l = 0; $l < count($arquivo); $l++) {
            ...
            switch ($dados[0]) {
                ...
                case "B13":
                    ...
                    $dados[1] = explode(',', $dados[1]);
                    foreach ($dados[1] as $ref) {
                        $notas[$currnota]['NFref'][] = $dom->createElement("NFref");
                        $NFref = & end($notas[$currnota]['NFref']);
                        $ide->appendChild($NFref);

                        $refNFe = $dom->createElement("refNFe", $ref);
                ...
                case "B20j":
                    ...
                    break;
                case "B25c":
                    $indIntermed = $dom->createElement("indIntermed", $dados[1]);
                    $procEmi = $ide->getElementsByTagName("procEmi")->item(0);
                    $ide->insertBefore($indIntermed,$procEmi);
                ...
                case "GA":
                    ...
                    if(!empty($dados[1]))
                      $ID = $dom->createElement("CPF", $dados[1]);
                    if(!empty($dados[2]))
                      $ID = $dom->createElement("CNPJ", $dados[2]);


                    $autxml->appendChild($ID);
                ...
                case "I80":
                    ...
                    $rastro = $dom->createElement("rastro");
                    if (!empty($dados[1])) {
                    ...
                    if (!empty($dados[5])) {
                        $cAgreg = $dom->createElement("cAgreg", $dados[5]);
                        $rastro->appendChild($cAgreg);
                    }
                ...
                case "K":
                    ...
                    if (!empty($dados[1])) {
                        $cProdANVISA = $dom->createElement("cProdANVISA", $dados[1]);
                        $med->appendChild($cProdANVISA);
                    }
                    if (!empty($dados[2])) {
                        $xMotivoIsencao = $dom->createElement("xMotivoIsencao", $dados[2]);
                        $med->appendChild($xMotivoIsencao);
                    }
                    if (!empty($dados[3])) {
                        $vPMC = $dom->createElement("vPMC", $dados[3]);
                ...
                case "L101":
                    ...
                    $descANP = $dom->createElement("descANP", $dados[2]);
                    $comb->appendChild($descANP);
                    if (!empty($dados[3])) 
                    {
                ...
                case "N03":
                    ...
                    if (!empty($dados[13])) {
                        $vBCFCP = $dom->createElement("vBCFCP", $dados[13]);
                        $ICMS10->appendChild($vBCFCP);

                        $pFCP = $dom->createElement("pFCP", $dados[14]);
                        $ICMS10->appendChild($pFCP);

                        $vFCP = $dom->createElement("vFCP", $dados[15]);
                        $ICMS10->appendChild($vFCP);
                    }
                    ...
                    if (!empty($dados[16])) {
                        $vBCFCPST = $dom->createElement("vBCFCPST", $dados[16]);
                        $ICMS10->appendChild($vBCFCPST);

                        $pFCPST = $dom->createElement("pFCPST", $dados[17]);
                        $ICMS10->appendChild($pFCPST);

                        $vFCPST = $dom->createElement("vFCPST", $dados[18]);
                        $ICMS10->appendChild($vFCPST);
                    }
                ...
                case "N08":
                    ...
                    $pST = $dom->createElement("pST", $dados[4]);
                    $ICMS60->appendChild($pST);
                    $vICMSST = $dom->createElement("vICMSSTRet", $dados[5]);
                ...
                case "W02":
                    ...
                    if($this->versao=='4.00'){
                      $vFCPUFDest = $dom->createElement("vFCPUFDest", "0.00");
                      $ICMSTot->appendChild($vFCPUFDest);
                      $vICMSUFDest = $dom->createElement("vICMSUFDest", "0.00");
                      $ICMSTot->appendChild($vICMSUFDest);
                      $vICMSUFRemet = $dom->createElement("vICMSUFRemet", "0.00");
                      $ICMSTot->appendChild($vICMSUFRemet);
                      $vFCP = $dom->createElement("vFCP", "0.00");
                    ...
                    if($this->versao=='4.00'){
                      $vFCPST = $dom->createElement("vFCPST", '0.00');
                      $ICMSTot->appendChild($vFCPST);
                      $vFCPSTRet = $dom->createElement("vFCPSTRet", '0.00');
                    ...
                    if($this->versao=='4.00'){
                      $vIPIDevol = $dom->createElement("vIPIDevol","0.00");
                ...
                case "YB":
                    ...
                    $infInterme     = $dom->createElement("infIntermed");
                    $CNPJ           = $dom->createElement("CNPJ",$dados[1]);
                    $infInterme->appendChild($CNPJ);
                    $idCadIntTran   = $dom->createElement("idCadIntTran",$dados[2]);
                    $infInterme->appendChild($idCadIntTran);
                    $infNFe->appendChild($infInterme);
                break;
                case "Z":
                ...
                case "ZC10":
                    ...
                    break;
                case "RPTEC":
                    $infRespTec = $dom->createElement("infRespTec");
                    $CNPJ =  $dom->createElement("CNPJ", $dados[1]);
                    $infRespTec->appendChild($CNPJ);
                    $xContato =  $dom->createElement("xContato", $dados[2]);
                    $infRespTec->appendChild($xContato);
                    $email =  $dom->createElement("email", $dados[3]);
                    $infRespTec->appendChild($email);
                    $fone =  $dom->createElement("fone", $dados[4]);
                    $infRespTec->appendChild($fone);
