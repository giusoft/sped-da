...
if ($gPathLib <> "") {
	...
	include $gPathLib . NFEPHP . "/libs/ConvertNFePHP.class.php";
} else {
	...
	include $gPathDefault . NFEPHP . "/libs/ConvertNFePHP.class.php";
}
...
class gNFe extends ConvertNFePHP
{
    ...
    function geraTxt()
    {
        ...
        foreach ($this->i as $item) {
            ...
            $outrasDespesas = $this->c['outrasDespesas'];
            if (floatval($outrasDespesas) > 0) {
                $m[] = number_format($outrasDespesas, 2, ".", ""); //outros
            } else {
                $m[] = "0";
            }
        ...
        if (($this->c['transportadoraCnpj'] <> "") || ($this->c['transportadoraCpf'] <> "")) {
            ...
            if (intval($this->c['quantidadeEspecie']) > 0) {
                $s.="X26|" . intval($this->c['quantidadeEspecie']) . "|" . $this->c['especieTransportada'] . "|||" . number_format($total_pl, 3, ".", "") . "|" . number_format($total_pb, 3, ".", "") . NL;
            } else {
