...
class gNotas
{
    ...
    function __construct(public $production = false, private $homologation = true)
    {
    ...
    public function connecta($method, string $endpoint, $header = NULL, $body = NULL)
    {
     ...
     * Consulta Nota.
     */
    public function consultaNota(string $id)
    {
     ...
     * Consulta Nota.
     */
    public function consultaNotaPDF(string $id)
    {
     ...
     * Consulta Nota.
     */
    public function consultaNotaXML(string $id)
    {
