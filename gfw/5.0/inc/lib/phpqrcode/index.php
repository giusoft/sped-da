...
// Set writable location for temporary PNG files
...
if (
    ...
    in_array($_REQUEST['level'], ['L', 'M', 'Q', 'H'], true)
) {
...
if (isset($_REQUEST['data'])) {
    ...
    $filename = $PNG_TEMP_DIR . 'test' . md5(
        $_REQUEST['data'] . '|' . $errorCorrectionLevel . '|' . $matrixPointSize
    ) . '.png';
    ...
    echo '<a href="?data=like_that">like that</a><hr/>';
