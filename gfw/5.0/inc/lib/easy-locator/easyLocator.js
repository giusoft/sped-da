   ...
   this.easyLocatorMethods = {
      ...
      loadScripts : function(container) { 
         ...
         var scriptMapUrl = 'https://maps.googleapis.com/maps/api/js?libraries=places&signed_in=true' +
            '&signed_in=true&language=pt_BR&callback=window.easyLocatorMethods.loadMap';
         ...
         if(typeof google === 'object' && typeof google.maps === 'object') {
            ...
            if(typeof this.options.apiKey !== 'undefined') {
               ...
               '&signed_in=true&language=pt_BR&key=' + this.options.apiKey + '&callback=window.easyLocatorMethods.loadMap';
            }            
      ...
      createButtonList: function(controlDiv) {
         var buttonOpenList = $.parseHTML('<div id="locatorMap_openList"><i class="fal fa-list"></i></div>')[0];        
