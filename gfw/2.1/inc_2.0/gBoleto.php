...
class gBoleto extends gPdf {
	...
	*/
	...
	function gPreparaBoleto($banco = gB_ITAU, $id_empresa = 0, $id_pessoa = 0, $valor = 0, $nosso_numero = 0, $numero_documento = '', $tipo_boleto = '0', $mes = '', $ano = '', $id_banco = 1, $data_automatica="")
...

	{
		...
		if ($id_empresa > 0) {
			...
			//REPRESENTA O BOLETO VINDO DO SITE  id_banco=13
...
*/
	...
	//	$nosso_numero_texto = getCodigoDigitavel();
		...
		$this->Text($mesq +17, $msupb +70, ($dados['sacado1'])."  ".$dados['sacado_cnpj']);
		$this->Text($mesq +17, $msupb +73, ($dados['sacado2']));
		$this->Text($mesq +17, $msupb +76, ($dados['sacado3']));
		$this->Text($mesq +17, $msupb +80, ($dados['sacador'])."  ".$dados['sacador_cnpj']);
